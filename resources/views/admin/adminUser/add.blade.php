        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="layui-form" method="post"
                      action="@if(isset($id)){{ route('admin::adminUser.update', ['id' => $id]) }}@else{{ route('admin::adminUser.save') }}@endif">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-11">
                            <div class="input-group form-group">
                                ...
                                <input class="form-control" type="text" name="name" aria-label="Username"
                                       aria-describedby="icon-addon1" value="{{ $user->name ?? ''  }}">
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-11">
                            <div class="input-group form-group">
                                ...
                                <input class="form-control" type="password" name="password"
                                       placeholder="{{trans('adminUser.passRemark')}}" aria-label="Password"
                            ...
                            <div class="col-sm-11">
                                <div style="padding-top:10px;" class="custom-control custom-switch custom-switch-info">
                                    <input class="custom-control-input" type="checkbox" id="gbflvjkj" name="status"
                                           value="1"
                                           @if(isset($user) && $user->status == App\Models\Admin\AdminUser::STATUS_ENABLE) checked @endif />
                        ...
                        <div class="row row-10 align-items-center">
                            ...
                            @else
                                <div class="col-sm-12 text-sm-center">
                                    ...
                                    <div style="display:inline;float:right;">
                                        <button type="reset"
                                                class="btn btn-secondary">{{trans('general.reset')}}</button>
                                        <button type="button" class="btn btn-warning"
                                                onclick="history.go(-1);">{{trans('general.return')}}</button>
                                    </div>
                                </div>
