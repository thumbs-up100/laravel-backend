...
//          'breadcrumb' => $this->breadcrumb,
    ...
    public function save(MenuRequest $request)
    {
        try {
            ...
            return [
                'code' => 1,
                'msg' => trans('general.createFailed') . ":" . (Str::contains($e->getMessage(), 'Duplicate entry') ? '当前菜单已存在' : '其它错误'),
                'redirect' => false
            ];
        }
    }
    ...
    public function update(MenuRequest $request, $id)
    {
        ...
        try {
            ...
            return [
                'code' => 1,
                'msg' => trans('general.updateFailed') . ":" . (Str::contains($e->getMessage(), 'Duplicate entry') ? '当前菜单已存在' : '其它错误'),
                'redirect' => false
            ];
        }
    }
