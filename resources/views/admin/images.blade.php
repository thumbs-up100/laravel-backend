@foreach($images as $key => $value)
    <div class="dz-preview dz-processing dz-image-preview dz-complete">
        <div class="dz-image"><img data-dz-thumbnail="" class="images-thumb" alt="img-01-720x330.jpg"
                                   src="{{ $value }}">
            <input class="dropzone-input"
                   type="hidden" name="image[]"
                   value="{{ str_replace(env('FILE_URL') . '/', '', $value) }}">
        </div>
        <div class="dz-details">
            <div class="dz-size"><span data-dz-size=""><strong>91.2</strong> KB</span>
            </div>
        ...
        <a class="dz-remove" onclick="removeImage(this);"
           data-dz-remove=""><span class="fa-close"></span></a>
    </div>
@endforeach
