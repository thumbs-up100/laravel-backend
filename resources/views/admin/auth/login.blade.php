                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-xl-5">
                                ...
                                <div class="mt-3 text-center"><img class="rounded-circle"
                                                                   src="/images/users/user-09-247x247.jpg" width="100"
                                                                   height="100" alt=""></div>
                                        ...
                                        <div class="col-12 col-md-10">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" id="user" type="text" name="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="captcha"
                                                           id="login-vercode" placeholder="图形验证码">
                                                    <div style="margin-left: 10px;height: 50px;">
                                                        <img src="{{ captcha_src() }}" id="get-vercode" title="点击刷新验证码"
