...
//          'breadcrumb' => $this->breadcrumb,
    ...
    public function save(ConfigRequest $request)
    {
        try {
            ...
            return [
                'code' => 1,
                'msg' => trans('general.createFailed') . ":" . (Str::contains($e->getMessage(), 'Duplicate entry') ? '当前配置已存在' : '其它错误'),
                'redirect' => false
            ];
        }
    }
    ...
    public function update(ConfigRequest $request, $id)
    {
        ...
        try {
            ...
            return [
                'code' => 1,
                'msg' => trans('general.updateFailed') . ":" . (Str::contains($e->getMessage(), 'Duplicate entry') ? '当前配置已存在' : '其它错误'),
                'redirect' => false
            ];
        }
    }
