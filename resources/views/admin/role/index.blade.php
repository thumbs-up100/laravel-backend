            ...
            <div class="panel-header">
                ...
                <div style="margin-top: 20px;">
                    <form name="admin_list_sea" class="form-search" method="get"
                          action="{{ route('admin::role.index') }}">
                        {{ csrf_field() }}
                        <div class="row row-15">
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input class="form-control" id="text" type="text"
                                           placeholder="{{trans('role.name')}}" name="name">
                                </div>
                            </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="{{ route('admin::role.edit', ['id' => $v['id']]) }}">{{trans('role.editRole')}}</a>
                                                <a class="dropdown-item"
                                                   href="{{ route('admin::role.permission.edit', ['id' => $v['id']]) }}">{{trans('role.privileges')}}</a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-primary"
                                                        onclick="deleteRole('{{ route('admin::role.delete', ['id' => $v['id']]) }}')">{{trans('general.confirm')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
